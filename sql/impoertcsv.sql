...
BEGIN
    colloid := OID.NEXTVAL;
    F := UTL_FILE.FOPEN ('DATA_PUMP_DIR', 'ordWebSD.csv', 'R');
    IF UTL_FILE.IS_OPEN(F) THEN
        ...
        INSERT INTO FAI_ORDINE_IN_COLLECTION
            ...
            VALUES(colloid, 'FAKE.CSV', CURRENT_TIMESTAMP, 3,'LORETO',-1,SYS_GUID);
        LOOP
        BEGIN
            ...
            IF V_LINE IS not NULL THEN
                ...
                IF qta != 'qta' THEN
                    ...
                    INSERT INTO FAI_ORDINE_IN_RIGA_DETTAGLIO
                        ...
                        VALUES(ordrigaoid, minsan, couponTitle,  minsan,  TO_NUMBER(qta), 0, ordoid,SYSDATE  , minsan, null, coupon, 'LORETO',0);
