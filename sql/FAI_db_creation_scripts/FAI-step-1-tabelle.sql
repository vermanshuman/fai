...
(
	...
	SERVICE_QUERY_SMTWTFS CHAR(7) DEFAULT  'CCCCCCC'  CONSTRAINT NN_IMPPRO_SQSMTWTFS NOT NULL  CONSTRAINT  CK_IMPPRO_SQSMTWTFS CHECK (REGEXP_LIKE(SERVICE_QUERY_SMTWTFS, '^[CV\-]*$')),
	...
	LAST_RUN_START_TS    DATE NULL ,
	LAST_RUN_END_TS      DATE NULL ,
	LAST_RUN_TYPE        CHAR(1) NULL  CONSTRAINT  CK_IMPPRO_LASTRTYPE CHECK (LAST_RUN_TYPE IN ('C', 'V')),
