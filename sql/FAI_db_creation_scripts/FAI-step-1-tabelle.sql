...
(
	...
	RUN_DONE             CHAR(1) NULL  CONSTRAINT  CK_VR_EXPCFG_LASTRDONE CHECK (LAST_RUN_DONE in ('S', 'N')),
	RUN_DESCR            CLOB NULL
);
...
CREATE UNIQUE INDEX UXUPLOADTASK_ACR ON FAI_UPLOAD_TASK
(MAGAZZINO_ACRONYM   ASC)
	TABLESPACE FAI_IDX;
