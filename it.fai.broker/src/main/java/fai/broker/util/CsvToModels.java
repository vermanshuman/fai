  ...
  private void parseLine() throws Exception {
    try {
      ...
      if (parseAsRigaTestata) {
        ...
        ordine.setCittaAcquirente(csv.getString("Citt� dell'acquirente", true, true));
        ...
        ordine.setQuantita(csv.getInteger("Quantit�", true, true));
        ...
        ordine.setCittaFatturazione(csv.getString("Citt� fatturazione", true, true));
      ...
      if (parseAsRigaDettaglio) {
        ...
        riga.setQuantita(csv.getInteger("Quantit�", true, true));
