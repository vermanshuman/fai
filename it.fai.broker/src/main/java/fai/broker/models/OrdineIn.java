...
public class OrdineIn extends AbstractModel {
    ...
    public static int OID_ORDINEINCOLLECTION;
    public static int FULFILLED;
    ...
    public static final Attribute[] attributes = buildAttributes(OrdineIn.class, new Attribute[]{ //@formatter:off
            ...
            new Attribute("oidCollection", null, Long.class, null, false, Attribute.DETAIL, false, Attribute.NO_OPTION),
            new Attribute("fulfilled", null, Boolean.class, null, false, Attribute.NOREF, false, Attribute.NO_OPTION),
            new Attribute("orderCount", null, Integer.class, null, false, Attribute.DETAIL, false, Attribute.NO_OPTION),
     ...
     * OID_COLLECTION
     **/
    public boolean setOIdCollection(Long oidCollection) {
        return setLong(OID_ORDINEINCOLLECTION, oidCollection);
    }

    public Long getOIdCollection() {
        return getLong(OID_ORDINEINCOLLECTION);
    }



  /** FULFILLED **/
  public boolean setFulfilled(Boolean fulfilled) {
    return setBoolean(FULFILLED, fulfilled);
  }

  public Boolean getFulfilled() {
    return getBoolean(FULFILLED);
  }

  public boolean isFulfilled() {
    return isBoolean(FULFILLED);
  }
