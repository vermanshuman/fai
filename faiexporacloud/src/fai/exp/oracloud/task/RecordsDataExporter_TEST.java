...
public class RecordsDataExporter_TEST {
  ...
  static void setLoggerProperty(java.util.Properties properties, String key, String defaultValue) {
   ...
   public static void main(String[] args) throws Exception {
    ...
    FaiExportConfig config = fai.exp.oracloud.db.SqlQueries.getFaiExportConfig(conn);
    RecordsDataExporter dataImporter = new RecordsDataExporter(Calendar.getInstance(), config, conn);
    dataImporter.doJob();
  }
