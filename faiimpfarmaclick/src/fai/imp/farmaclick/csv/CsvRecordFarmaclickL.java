...
public class CsvRecordFarmaclickL extends CsvFarmaclickCommons {
  ...
  public Double getPercScontoPrezzoPubblicoVsNettoUnitario() {
    try {
      ...
      if (WORKAROUNDS.isEnabledRecordL_getPercScontoPrezzoPubblicoVsNettoUnitario() == false) throw e;
  ...
  public Double getPercScontoPrezzoPubblicoDerivatoVsNettoUnitario() {
    try {
      ...
      if (WORKAROUNDS.isEnabledRecordL_getPercScontoPrezzoPubblicoDerivatoVsNettoUnitario() == false) throw e;
      logger.warn("**** ATTENZIONE! APPLICATO WORKAROUND PER METODO "+(new Object() {}.getClass().getEnclosingMethod().getName())+": QUESTO MESSAGGIO NON DEVE MAI COMPARIRE IN AMBIENTE DI PRODUZIONE!!! ****");
      return new Double(0);
    }
